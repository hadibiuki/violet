 ...
 */
export function OrderTimeline({ current = "submitted", rejected = false, times = {}, labels = {}, orientation = "vertical", style, ...rest }: OrderTimelineProps) {
  const steps: [string, string][] = rejected
