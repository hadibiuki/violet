 ...
 */
export function CartLineItem({ name, sku, image, price, qty, moq, currency = (n: number) => `$${n.toLocaleString()}`, editable = true, onQty, onRemove, style, ...rest }: CartLineItemProps) {
  return (
